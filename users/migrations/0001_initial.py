    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, default='profiles/default-profile-image.png', null=True, upload_to='profiles/')),
                ('social_github', models.CharField(blank=True, max_length=200, null=True)),
                ('social_leetcode', models.CharField(blank=True, max_length=200, null=True)),
